...
class BookSeeder extends Seeder
{
    public function run()
    {
        ...
        $books = [
            ...
            ['name' => 'Problematic Summer Romance', 'author' => 'Ali Hazelwood', 'price' => 10.99, 'language' => 'EN', 'rating' => 4, 'amount' => 6, 'release_date' => '2023-06-01', 'is_on_sale' => true, 'photo1' => 'problematic_summer_romance.JPG', 'is_recommended' => true,'categories' => [$romance->category_id]],
            ...
            ['name' => 'Žltá hviezda', 'author' => 'Jennifer Roy', 'price' => 10.50, 'language' => 'SK', 'rating' => 5, 'amount' => 8, 'release_date' => '2006-01-01', 'is_on_sale' => false, 'photo1' => 'zlta_hviezda.JPG', 'categories' => [$ya->category_id]],
            ...
            // Manga
            ['name' => 'Attack on Titan vol.1', 'author' => 'Hajime Isayama', 'price' => 10.00, 'language' => 'EN', 'rating' => 5, 'amount' => 15, 'release_date' => '2009-09-09', 'is_on_sale' => false, 'photo1' => 'attack_on_titan_1.JPG', 'categories' => [$manga->category_id]],
            ['name' => 'Attack on Titan vol.2', 'author' => 'Hajime Isayama', 'price' => 10.00, 'language' => 'EN', 'rating' => 5, 'amount' => 15, 'release_date' => '2009-12-09', 'is_on_sale' => false, 'photo1' => 'attack_on_titan_2.JPG', 'categories' => [$manga->category_id]],
            ['name' => 'Attack on Titan vol.3', 'author' => 'Hajime Isayama', 'price' => 10.00, 'language' => 'EN', 'rating' => 5, 'amount' => 15, 'release_date' => '2010-03-09', 'is_on_sale' => false, 'photo1' => 'attack_on_titan_3.JPG', 'categories' => [$manga->category_id]],
            ['name' => 'Attack on Titan vol.4', 'author' => 'Hajime Isayama', 'price' => 10.00, 'language' => 'EN', 'rating' => 5, 'amount' => 15, 'release_date' => '2010-06-09', 'is_on_sale' => false, 'photo1' => 'attack_on_titan_4.JPG', 'categories' => [$manga->category_id]],
            ['name' => 'Attack on Titan vol.5', 'author' => 'Hajime Isayama', 'price' => 10.00, 'language' => 'EN', 'rating' => 5, 'amount' => 15, 'release_date' => '2010-09-09', 'is_on_sale' => false, 'photo1' => 'attack_on_titan_5.JPG', 'categories' => [$manga->category_id]],
            ...
            // Historical
            ['name' => 'Posledný Žid z Treblinky', 'author' => 'Chil Reichman', 'price' => 12.99, 'language' => 'SK', 'rating' => 5, 'amount' => 8, 'release_date' => '2006-01-01', 'is_on_sale' => false, 'photo1' => 'posledny_zid.JPG', 'categories' => [$historical->category_id]],
